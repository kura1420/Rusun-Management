...
<x-adminlte-card theme="primary" theme-mode="outline" title="{{$subTitle}}">
    <x-slot name="toolsSlot">
        <a href="{{route('program-kegiatan.index', ['program_id' => $programKegiatan->program_id])}}" class="btn btn-sm btn-dark">
            <i class="fa fa-arrow-left"></i> Kembali
        </a>

        <a href="{{route('program-laporan.create', ['program_kegiatan_id' => $programKegiatan->id])}}" class="btn btn-sm btn-primary">
