...
<x-adminlte-card theme="primary" theme-mode="outline" title="{{$subTitle}}">
    <x-slot name="toolsSlot">
        <a href="{{route('rusun-unit-detail.index')}}" class="btn btn-sm btn-dark"> <i class="fa fa-arrow-left"></i> Kembali </a>
    </x-slot>
    ...
    <div class="row">
        ...
        <x-adminlte-input name="ukuran" id="ukuran" label="Ukuran" placeholder="Ukuran" fgroup-class="col-md-2" value="{{$row->ukuran}}" />
...
$(function () {
    ...
    $('#btnSubmit').click(function (e) { 
        ...
        $.ajax({
            type: "POST",
            url: "{{route('rusun-unit-detail.updateAsStore', $row->id)}}",
            data: formData,
            dataType: "json",
            contentType: false,
            processData: false,
