...
class CreateProgramKanidatTerpilihsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('program_kanidat_terpilihs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('program_kanidat_terpilihs');
    }
}
